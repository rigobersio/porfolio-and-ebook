...
const Skills: React.FC = () => {
  ...
  return (
    <div id="Skills" className="lg:w-2/3 sm:w-auto flex flex-col items-center justify-center" ref={skillsRef}>
      ...
      <div className="bg-gray-200 rounded-full p-5 lg:p-3 shadow-lg">
        <div className="bg-white rounded-full p-5 lg:p-3 flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8">
